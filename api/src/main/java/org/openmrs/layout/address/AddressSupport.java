    ...
    private void setAddressTemplate(String xml) {
        ...
        try {
            if (org.apache.commons.lang3.StringUtils.isBlank(xml)) {
                xml = org.openmrs.util.OpenmrsConstants.DEFAULT_ADDRESS_TEMPLATE;
            }
        ...
        } catch (org.openmrs.serialization.SerializationException | org.openmrs.api.APIException e) {
